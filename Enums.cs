...
public enum EmployeeRole { Director, ProductionManager, Engineer, Technician, MachineOperator, SalesAgent }
public enum ProductionOrderStatus { Created, InProgress, Completed }
